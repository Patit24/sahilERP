    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage credit notes for {currentFY}</p>
        </div>
                    ...
                    <TableRow key={item.id}>
                      ...
                      <TableCell className="font-medium">
                        <div className="flex items-center gap-2">
                          ...
                          {isAuto && (
                            <span className="inline-flex items-center rounded-md bg-amber-500/10 px-2 py-0.5 text-[10px] font-semibold text-amber-700 dark:text-amber-400 border border-amber-500/20" title="Auto-generated from Sales Return">
                              Auto (SR)
                            </span>
                          )}
                        </div>
